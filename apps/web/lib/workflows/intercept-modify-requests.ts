export const interceptModifyRequests = `// Original at: https://github.com/mxschmitt/try-playwright/blob/main/frontend/src/examples/javascript/intercept-modify-requests.js
